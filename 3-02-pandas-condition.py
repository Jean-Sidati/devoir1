...
print(pd.Series.unique(df['Pclass']))

passenger = (df['Pclass']>0)

hommes1 = (df['Sex'] == 'male') & (df['Pclass'] == 1) 
femmes1 = (df['Sex'] == 'female') & (df['Pclass'] == 1)

hommes2 = (df['Sex'] == 'male') & (df['Pclass'] == 2) 
femmes2 = (df['Sex'] == 'female') & (df['Pclass'] == 2) 

hommes3 = (df['Sex'] == 'male') & (df['Pclass'] == 3)
femmes3 = (df['Sex'] == 'female') & (df['Pclass'] == 3)

#Survivant par sexe et classe
hommes1_surv = (df['Sex'] == 'male') & (df['Pclass'] == 1) & (df['Survived'] == 1)
femmes1_surv = (df['Sex'] == 'female') & (df['Pclass'] == 1) & (df['Survived'] == 1)

hommes2_surv = (df['Sex'] == 'male') & (df['Pclass'] == 2) & (df['Survived'] == 1)
femmes2_surv = (df['Sex'] == 'female') & (df['Pclass'] == 2) & (df['Survived'] == 1)

hommes3_surv = (df['Sex'] == 'male') & (df['Pclass'] == 3) & (df['Survived'] == 1)
femmes3_surv = (df['Sex'] == 'female') & (df['Pclass'] == 3) & (df['Survived'] == 1)

passenger_surv= (df['Pclass']>0) & (df['Survived'] == 1)

print((femmes1_surv.sum())/(femmes1.sum()))
